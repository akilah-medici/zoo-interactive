# Guia de Inicialização do Projeto via Docker

Este guia descreve como iniciar o projeto localmente utilizando Docker, incluindo os passos para buildar os containers, criar e popular o banco de dados, e iniciar os serviços.
...
Siga estes passos para garantir que o ambiente esteja pronto para uso localmente via Docker.
